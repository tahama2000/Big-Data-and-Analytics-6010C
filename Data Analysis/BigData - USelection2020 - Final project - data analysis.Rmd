---
title: "The Story Behind The 2020 U.S. Presidential Election: A Big Data Analysis using Social Media - Data Analysis"
author: "Team C"
date: "3/3/2021"
output:
...
## Election Results
```{r , echo=TRUE}
election.results <- read_csv("Data/1976-2020-president.csv") 
```
```{r , echo=TRUE}
